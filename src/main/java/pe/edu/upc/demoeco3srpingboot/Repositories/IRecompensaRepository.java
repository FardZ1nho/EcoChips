...
public interface IRecompensaRepository extends JpaRepository<Recompensa, Integer> {
    ...
    List<Recompensa> findByCostoCanjesLessThanEqual(int canjes);

    List<Recompensa> findByCostoCanjes(int canjes);

    List<Recompensa> findByTituloRecompensaContainingIgnoreCase(String titulo);
}
